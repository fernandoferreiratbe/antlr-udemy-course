...
def serializedATN():
    return [
        ...
        0,0,0,18,19,5,42,0,0,19,4,1,0,0,0,20,21,5,47,0,0,21,6,1,0,0,0,22,
        23,5,43,0,0,23,8,1,0,0,0,24,25,5,45,0,0,25,10,1,0,0,0,26,28,7,1,
...
class ExprLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "NUM", "MUL", "DIV", "PLUS", "SUB", "WS" ]

    ruleNames = [ "NUM", "MUL", "DIV", "PLUS", "SUB", "WS" ]
